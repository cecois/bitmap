...
templates['hitMarkerViewTpl'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  var stack1, helper, lambda=this.lambda, escapeExpression=this.escapeExpression, functionType="function", helperMissing=helpers.helperMissing, buffer = "<div class=\"btn-group btn-group-xs\" role=\"group\" aria-label=\"...\">\n\n<button data-target=\"marker\" type=\"button\" class=\"btn btn-default btn-pu-nav active\"><span class=\"bt-cartoobj bt-cartoobj-feedback carto-plain-geomtype icom-"
    + escapeExpression(lambda((depth0 != null ? depth0.geom_type : depth0), depth0))
    + "\"></span></button>\n\n  <button data-target=\"episodes\" data-id=\"episodes\" type=\"button\" class=\"btn btn-default btn-pu-nav\"><span data-id=\""
    ...
    + "\" class=\"glyphicon glyphicon-headphones bt-cartoobj bt-cartoobj-episodes\" title=\"pull a list of referencing episodes\"></span></button>\n\n  <button data-target=\"feedback\" data-id=\"feedback\" type=\"button\" class=\"btn btn-default btn-pu-nav\"><span data-id=\""
    + escapeExpression(((helper = (helper = helpers.cartodb_id || (depth0 != null ? depth0.cartodb_id : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"cartodb_id","hash":{},"data":data}) : helper)))
    + "\" data-type=\""
    + escapeExpression(((helper = (helper = helpers.geom_type || (depth0 != null ? depth0.geom_type : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"geom_type","hash":{},"data":data}) : helper)))
    + "\" class=\"glyphicon glyphicon-edit bt-cartoobj bt-cartoobj-feedback\" title=\"pull a list of referencing episodes\"></span></button>\n\n</div>\n\n\n<div class=\"pu-copy pu-copy-marker\">\n<h5>"
  ...
  if (stack1 != null) { buffer += stack1; }
  return buffer + "</div>\n\n<div class=\"hidden pu-copy pu-copy-episodes\">\n<p class=\"text-muted\">HEYOOOOOO eps</p></div>\n\n<div class=\"hidden pu-copy pu-copy-feedback\">\n<p class=\"text-muted\">HEYOO feed</p></div>";
},"useData":true});
