...
templates['querySubNavViewTpl'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  return " <div class=\"querysubnavh col-sm-12 pull-left\">\n	<span data-id=\"bits\" class=\"query-subnav-btn col-sm-2 pull-left\"><span class=\"col-sm-8\">Bits: </span><span class=\"col-sm-offset-1 col-sm-3 query-subnav-count query-subnav-count-bits\"></span></span>\n	<span data-id=\"locations\" class=\"query-subnav-btn col-sm-4 pull-left active\"><span class=\"col-sm-8\">Locations: </span><span class=\"col-sm-offset-1 col-sm-3 query-subnav-count query-subnav-count-locations\"></span></span>\n	</div>";
  },"useData":true});
