...
templates['recentsViewTpl'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  var stack1, helper, options, lambda=this.lambda, escapeExpression=this.escapeExpression, functionType="function", helperMissing=helpers.helperMissing, blockHelperMissing=helpers.blockHelperMissing, buffer = "            <span class=\"copy-trigger\" data-toggle=\"tooltip\" data-string='instance:\""
...
templates['sharesViewTpl'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += "</div>\n    </div>\n\n    <div>On platforms that support them, your hashtag(s) will be: <div class=\"social-share-value\">"
  ...
  if (stack1 != null) { buffer += stack1; }
  return buffer + "</ul>\n<div class=\"row\">\n    <div class=\"pull-right\" style=\"color:black; padding-right:22px;\">\n        this project on Twitter: <a target=\"blank\" style=\"color:black;\" class=\"\" id=\"\" href=\"http://twitter.com/jokemap\" target=\"_blank\" title=\"this thing's Twitter account\"><span style=\"font-size:2em;\" class=\"icom-social-twitter\"></span></a>\n    </div></div>";
